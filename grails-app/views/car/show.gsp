	...
	<body>
		...
		<div id="show-car" class="content scaffold-show" role="main">
			...
			<ol class="property-list car">
				...
				<g:if test="${carInstance?.fuelConsumption}">
				<li class="fieldcontain">
					<span id="fuelConsumption-label" class="property-label"><g:message code="car.fuelConsumption.label" default="Fuel Consumption" /></span>
					
						<span class="property-value" aria-labelledby="fuelConsumption-label"><g:fieldValue bean="${carInstance}" field="fuelConsumption"/></span>
