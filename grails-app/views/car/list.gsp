			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="fuelConsumption" title="${message(code: 'car.fuelConsumption.label', default: 'Fuel Consumption')}" />
				...
				<g:each in="${carInstanceList}" status="i" var="carInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${carInstance.id}">${fieldValue(bean: carInstance, field: "fuelConsumption")}</g:link></td>
