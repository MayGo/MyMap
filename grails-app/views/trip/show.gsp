	...
	<body>
		...
		<div id="show-trip" class="content scaffold-show" role="main">
			...
			<ol class="property-list trip">
				...
				<g:if test="${tripInstance?.routes}">
				<li class="fieldcontain">
					<span id="routes-label" class="property-label"><g:message code="trip.routes.label" default="Routes" /></span>
					
						<g:each in="${tripInstance.routes}" var="r">
